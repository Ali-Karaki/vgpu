...
export function Example() {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-[#090b10]">
      <canvas ref={canvasRef} className="block h-full w-full" aria-label="Holographic foil card. Move your pointer or drag to tilt the card and shift its rainbow reflections." />
